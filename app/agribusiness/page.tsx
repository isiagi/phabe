            ...
            <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-3">
              <div className="col-span-1 lg:col-span-3 mb-8">
                ...
                <p className="mt-4 text-muted-foreground">
                  Agribusiness products and services range from procuring of the
                  Agricultural products from the farmers and ensuring proper
                  storage. We also carry out value addition to the agricultural
                  products produced by our farmers. Phabe investments contribute
                  financial support to the farmers and also offer suitable
                  market price for the farmers and solicits for the market for
                  the product which makes it a sole buyer from the farmers.
                </p>
              </div>
