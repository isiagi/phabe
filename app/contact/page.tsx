    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <PageHeader
          ...
          backgroundImage="https://images.unsplash.com/photo-1596524430615-b46475ddff6e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y29udGFjdCUyMHVzfGVufDB8fDB8fHww"
          showBackLink={false}
        />
            ...
            <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-2">
              ...
              >
                <div>
                  ...
                  <p className="text-muted-foreground mb-8">
                    You can also reach us using the following contact
                    information or visit our office in Seeta, Mukono.
                  </p>
                </div>
                <div className="grid gap-6">
                  {[
                    ...
                    },
                    {
                      ...
                      content: (
                        <>
                          General Inquiries: phabeinvestment@gmail.com
                          <br />
                          Customer Support: phabeinvestment@gmail.com
                          <br />
                          Careers: phabeinvestment@gmail.com
                        </>
                      ),
                    },
                    {
                      ...
                      content: (
                        <>
                          Main Office: +256 779 355824
                          <br />
                          Customer Service: +256 706 702 719
                          <br />
                          WhatsApp: +256 706 702 719
                        </>
                      ),
                    },
                    {
                ...
                <AnimatedSection
                  className="rounded-xl border bg-background p-6 shadow-sm mt-8"
                  delay={400}
                >
                  <DecoratedTitle
                    as="h3"
